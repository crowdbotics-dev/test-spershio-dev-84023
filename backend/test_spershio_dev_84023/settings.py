"""
Django settings for test_spershio_dev_84023 project.
...
ROOT_URLCONF = 'test_spershio_dev_84023.urls'
...
WSGI_APPLICATION = 'test_spershio_dev_84023.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_spershio_dev_84023 API",
    "DESCRIPTION": "API documentation for test_spershio_dev_84023 App",
    "VERSION": "v1",
}
