...
## Project Structure
    ...
    ├── test_spershio_dev_84023  # Django project configurations
...
1. Clone this repo and `cd test_spershio_dev_84023`
...
2. Clone this repo and `cd test_spershio_dev_84023`
